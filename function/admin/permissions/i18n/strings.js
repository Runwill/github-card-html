(function(){
    const zh = {
        ...
        'permissions.log.filter.scopeLabel': '范围',
        ...
        'permissions.log.filter.scope.active': '当前',
        'permissions.log.filter.scope.trash': '回收站',
    ...
    const en = {
        ...
        'permissions.log.filter.scopeLabel': 'Scope',
        ...
        'permissions.log.filter.scope.active': 'Current',
        'permissions.log.filter.scope.trash': 'Trash',
