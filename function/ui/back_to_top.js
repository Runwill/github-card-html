;(function(){
  ...
  // 不设置 title，避免悬浮提示气泡
    // 使用内联 SVG，避免额外请求
    btn.innerHTML = '<svg class="back-to-top__icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 19V5" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><path d="M6 10l6-6 6 6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>'
