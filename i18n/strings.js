(function(){
  const zh = {
    ...
    'keySettings.expandAll': '术语：展开所有术语',
    'keySettings.inspect': '全局：显示属性',
    'keySettings.toggleTheme': '全局：切换深浅色',
    'keySettings.editorFocusSearch': '草稿：聚焦搜索',
    'keySettings.editorClearSelection': '草稿：清除选择',
    'keySettings.editorAddChild': '草稿：添加子节点',
    'keySettings.editorAddSibling': '草稿：添加同级节点',
    'keySettings.editorEditSelected': '草稿：编辑选中节点',
    'keySettings.editorDeleteSelected': '草稿：删除选中节点',
    'keySettings.editorVariantMode': '草稿：变体插入',
  ...
  const en = {
    ...
    'keySettings.expandAll': 'Terms: Expand all terms',
    'keySettings.inspect': 'Global: Show attributes',
    'keySettings.toggleTheme': 'Global: Toggle theme',
    'keySettings.editorFocusSearch': 'Draft: Focus search',
    'keySettings.editorClearSelection': 'Draft: Clear selection',
    'keySettings.editorAddChild': 'Draft: Add child node',
    'keySettings.editorAddSibling': 'Draft: Add sibling node',
    'keySettings.editorEditSelected': 'Draft: Edit selected node',
    'keySettings.editorDeleteSelected': 'Draft: Delete selected node',
    'keySettings.editorVariantMode': 'Draft: Variant insert',
