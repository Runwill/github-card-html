...
description: "Use when: 清理 card-html 技术债、合并同类语义定义、删除重复逻辑/冗余 CSS/JS/HTML、简化不合理架构、统一原生控件与自定义控件实现、处理屎山代码、减少覆盖层和死代码，处理 CSS !important、specificity、选择器优先级回归，以及清理后的流程汇报、视觉变化/可见差异说明、清理收益账、清理是否完成、按流程汇报、owner 合并汇报、机制移除汇报。"
